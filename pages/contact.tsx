  ...
  return (
    <Main>
      <article className="p-8 max-w-[800px] mx-auto mt-8">
        ...
        <p className="text-justify">Congratulations on taking the first step for taking your web presence to the next level! We're excited to help you with your project. Fill out the form below to reach me. Include in your message a general overview of what you want in your website and general plans to give me some context of your goals. Also, feel free to connect with us on <Link legacyBehavior={false} className="underline" href="https://www.linkedin.com/in/aaron-rutherford-67aaa917a/">LinkedIn</Link>.</p>

        <p className="text-justify">We'll reach out to you within a day or so and let you know what kind of work goes into the project you're looking for as well as an estimated price for the whole project, and we'll go from there!</p>
